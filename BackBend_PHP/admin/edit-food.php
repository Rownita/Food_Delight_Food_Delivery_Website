...
// ===================== submit single data for update into db================================
...
?> <div class="main-content">
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table class="add-table" width="30%">
                <tr>
                    <td>Title: </td>
                ...
                <tr>
                    <td>Description: </td>
                    <td><textarea name="description" cols="30" rows="5"><?= $description; ?></textarea>
                </tr>
